...
namespace Grm.BaseDados.WebAppl.Models.sindicato
{
    ...
    public class Sindicato: Pessoa
    {
        ...
        [Column("ID_TIPO_SIND")]
        [ForeignKey("SindicatoTipoSindicato")]
